...
def _work_to_response(work: Work) -> WorkResponse:
    ...
    return WorkResponse(
        ...
        cover_original_url=work.cover_original_url,
        cover_card_url=work.cover_card_url,
        cover_detail_url=work.cover_detail_url,
        cover_thumb_url=work.cover_thumb_url,
        cover_crop_data=work.cover_crop_data,
...
async def create_work(
    ...
    work = Work(
        ...
        cover_original_url=req.cover_original_url,
        cover_card_url=req.cover_card_url,
        cover_detail_url=req.cover_detail_url,
        cover_thumb_url=req.cover_thumb_url,
        cover_crop_data=req.cover_crop_data,
        content=req.content,
