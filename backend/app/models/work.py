...
class Work(Base):
    ...
    cover_original_url: Mapped[str] = mapped_column(Text, nullable=True, comment="封面原图")
    cover_card_url: Mapped[str] = mapped_column(Text, nullable=True, comment="列表卡片封面")
    cover_detail_url: Mapped[str] = mapped_column(Text, nullable=True, comment="详情页封面")
    cover_thumb_url: Mapped[str] = mapped_column(Text, nullable=True, comment="缩略封面")
    cover_crop_data: Mapped[str] = mapped_column(Text, nullable=True, comment="封面裁剪参数JSON")
